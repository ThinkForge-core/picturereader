...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var en = {
      ...
      ocrLanguage: "OCR default language (BCP-47, e.g. zh-Hans / en-US; empty = both models)",
      ocrLanguageHint: "Empty (or \"auto\") asks both bundled models and lets the model order below decide. A tag pins one model — and a pinned language overrides the model order, so the field below then has no effect.",
